...
const Header = () => {
  return (
    ...
    <div className='md:w-1/2 flex flex-col justify-start items-start gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]  '>
        ...
        <div className='flex flex-col gap-3 md:flex-row items-start text-white text-sm font-light'>
            <img className='w-16 md:w-20 lg:w-28 ' src={assets.group_profiles} alt="" />
